...
import com.szmirren.vxApi.core.entity.*;
...
public class SessionTokenGrantAuthHandler implements VxApiCustomHandler {
    private static final Logger LOG = LoggerFactory.getLogger(SessionTokenGrantAuthHandler.class);
     ...
     * @param queryParams 请求的queryParams
     * @param bodyParams  请求的bodyParams
     */

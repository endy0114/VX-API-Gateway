...
public class VxApiServerOptions extends HttpServerOptions {
     ...
     * 是否开启http服务
     */
    private boolean createHttp = true;
    /**
     * 是否开启https服务
     */
    private boolean createHttps = false;
    /**
     * 是否开启WebSocket服务
     */
    private boolean createwebSocket = false;
    /**
     * HTTP服务器的端口号
     */
     ...
     * WebSocket服务器的端口号
     */
    private int webSocketPort = WEB_SOCKET_DEFAULT_PORT;
    /**
     * 服务器证书
     */
    private VxApiCertOptions certOptions;
    /**
     * 拓展配置
     */

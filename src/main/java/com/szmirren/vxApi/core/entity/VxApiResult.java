...
public class VxApiResult {
     ...
     * 要透传的header
     */
    private Set<String> tranHeaders;
    /**
     * API请求服务器成功示例
     */
     ...
     * API网关入口参数检查失败返回结果
     */
    private String apiEnterCheckFailureExample;
    /**
     * API网关入口参数检查失败状态码
     */
    private int apiEnterCheckFailureStatus = 400;
    /**
     * 访问限制返回结果
     */
    private String limitExample;
    /**
     * 访问限制返回状态
     */
    private int limitStatus = 202;
    /**
     * API请求服务器失败示例
     */
     ...
     * API请求服务器失败状态码
     */
    private int failureStatus = 500;
    /**
     * API无法连接上后台服务器失败示例
     */
    private String cantConnServerExample;
    /**
     * API无法连接上后台服务器失败状态码
     */
    private int cantConnServerStatus = 504;
    /**
     * 状态码集合
     */
    private List<VxApiResultStatus> status;

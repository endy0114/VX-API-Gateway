...
public class VxApiAPILimit {
     ...
     * 统计时间
     */
    private Instant timePoints = Instant.now();
    /**
     * 用户ip统计
     */
    private Map<String, Long> userIpCurPoints = new HashMap<>();
    /**
     * ip限制的数量
     */
    private long ipTop = -1;
    /**
     * api的限制数量
     */
    private long apiTop = -1;
    /**
     * 当前的数量
     */
     ...
     * @param points
     */
    public void addUserIpCurPoints(String ip, long points) {

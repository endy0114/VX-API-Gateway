...
public class VxApiTrackInfo {
     ...
     * 用户请求的的主体buffer长度
     */
    private long requestBufferLen;
    /**
     * 服务端响应的主体buffer长度
     */
    private long responseBufferLen;
    /**
     * 是否成功
     */
     ...
     * @return
     */
    public static VxApiTrackInfo fromJson(JsonObject json) {
        if (json == null) {
            return null;
        }
        VxApiTrackInfo option = new VxApiTrackInfo();
     ...
     * @param apiName
     */
    public VxApiTrackInfo(String appName, String apiName) {
        super();

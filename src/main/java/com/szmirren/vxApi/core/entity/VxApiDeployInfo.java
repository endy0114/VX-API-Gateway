...
public class VxApiDeployInfo {
     ...
     * @param options  服务器配置信息
     */
    public VxApiDeployInfo(String appName, String deployId, VxApiServerOptions options) {
        super();
     ...
     * @param appName       应用的名字
     * @param deployId      部署的id
     * @param httpPort      http服务器端口号
     * @param httpsPort     https服务器端口号
     * @param webSocketPort webSocket端口号
     */
    public VxApiDeployInfo(String appName, String deployId, Integer httpPort, Integer httpsPort, Integer webSocketPort) {
        super();
        this.appName = appName;
        this.deployId = deployId;

 ...
 */
public class FreeMarkerTemplateHandler extends CachingTemplateEngine<Template> implements FreeMarkerTemplateEngine, TemplateHandler {

    private final Configuration config;
    private String contentType;

    public FreeMarkerTemplateHandler(Vertx vertx, String templateDirectory, String contentType) {

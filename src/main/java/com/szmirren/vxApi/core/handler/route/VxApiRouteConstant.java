...
public interface VxApiRouteConstant {
     ...
     */
    String BODY_KEY_CONTENT_LENGTH = "VxApiBodyContentLength";
    /**
     * 从RoutingContext获取用户请求PATH参数的key
     */
    String BODY_KEY_PATH_TYPE_MultiMap = "VxApiBodyPathParams";
    /**
     * 从RoutingContext获取用户请求HEADER参数的key
     */
    String BODY_KEY_HEADER_TYPE_MultiMap = "VxApiBodyHeaderParams";
    /**
     * 从RoutingContext获取用户请求QUERY参数的key
     */
    String BODY_KEY_QUERY_TYPE_QueryStringEncoder = "VxApiBodyQueryPathParams";
    /**
     * 从RoutingContext获取用户请求BODY参数的key
     */
    String BODY_KEY_BODY_TYPE_QueryStringEncoder = "VxApiBodyBodyPathParams";

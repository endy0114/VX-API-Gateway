...
public interface VxApiRouteHandlerHttpService extends Handler<RoutingContext> {
     ...
     *
     * @param appName    应用程序的名字
     * @param isNext     是否有下一个处理器
     * @param api        API配置文件
     * @param httpClient 与后台连接的客户端
     * @return
     * @throws NullPointerException
     * @throws MalformedURLException
     */
    static VxApiRouteHandlerHttpService create(String appName, boolean isNext, VxApi api, HttpClient httpClient)

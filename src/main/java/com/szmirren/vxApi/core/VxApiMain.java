        ...
        getConfig(conf -> {
            if (conf.succeeded()) {
                try {
                    ...
                    // CLI配置文件
                    JsonObject cliConfig = conf.result().getJsonObject("cliConfig", getDefaultCLIConfig());
                    ...
                    CompositeFuture.all(futures).onSuccess(fts -> {
                        ...
                        System.out.println("start VX-API unsuccessful");
                        System.out.println(fts.getCause());
                        fut.fail(fts.getCause());
                    });
                } catch (Exception e) {
                    System.out.println("start VX-API unsuccessful");
